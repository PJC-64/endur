...
This document explains the internal architecture, design patterns, and code structure of `new-durable`. It is intended for developers who wish to modify, debug, or extend the codebase.
...
### 1. Command-Line Interface ([src/main.rs](file:///Users/pjc/Development/new-durable/src/main.rs))
...
### 2. Runtime Locking & Single Instance enforcement ([src/database.rs](file:///Users/pjc/Development/new-durable/src/database.rs))
...
### 3. Client-Server IPC ([src/poller.rs](file:///Users/pjc/Development/new-durable/src/poller.rs))
...
### 4. File Watcher & Filter Engine ([src/watcher.rs](file:///Users/pjc/Development/new-durable/src/watcher.rs))
...
### 5. Daemon Control Loop ([src/poller.rs](file:///Users/pjc/Development/new-durable/src/poller.rs))
...
### 6. Isolated Snapshot Capture ([src/snapshots.rs](file:///Users/pjc/Development/new-durable/src/snapshots.rs))
...
### 7. Interactive TUI Restore ([src/tui.rs](file:///Users/pjc/Development/new-durable/src/tui.rs))
...
*   [tests/startup_test.rs](file:///Users/pjc/Development/new-durable/tests/startup_test.rs): Tests UDS communication, invalid lock files, and double-lock prevention.
*   [tests/watch_test.rs](file:///Users/pjc/Development/new-durable/tests/watch_test.rs): Tests watcher registration and event-driven backup snapshots.
*   [tests/snapshots_test.rs](file:///Users/pjc/Development/new-durable/tests/snapshots_test.rs): Tests Git index isolation, git ignore support, listing snapshots, and restoring snapshots.
*   [tests/poll_guard_test.rs](file:///Users/pjc/Development/new-durable/tests/poll_guard_test.rs): Tests poller lock mechanics and state changes.
